...
{	
	...
	{	
		//global.SONG_TO_PLAY	= audio_play_sound(global.SONG_TO_PLAY_ID, 1, 0);
	...
	global.SONG_POSITION	= audio_sync_group_get_track_pos(global.SONG_TO_PLAY);
	...
	if(global.ELAPSED_TIME >= global.NEXT_BEAT_TIME)
	{
		...
		global.SONG_POSITION_ADJUST	= 0;//(frac(global.ELAPSED_TIME) - frac(global.NEXT_BEAT_TIME));
